...
--
-- Host: 127.0.0.1
-- Generation Time: 09-Mar-2018 às 21:02
...
--
ALTER TABLE `lista_documento`
  MODIFY `idListaDocumento` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `pessoa_fisica`
  MODIFY `idPf` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pessoa_juridica`
--
ALTER TABLE `pessoa_juridica`
  MODIFY `idPj` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
