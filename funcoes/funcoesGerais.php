            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-theme"  type="button" class="btn btn-theme btn-lg btn-block"
                            data-toggle="modal" data-target="#novoMaterial">Editar</button>
                        <button class="btn btn-theme" data-toggle="modal" data-target="#apagarMaterial" onclick="prrencherModalApagar(<?= $material['idMaterial']?>)">Apagar</button>
                </td>
            </tr>
            <?php }
        ?>
