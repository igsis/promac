...
if(isset($_POST['login']))
{
	$login = $_POST['login'];
	$senha = $_POST['senha'];
	autenticaloginincentivadorpf($login,$senha);
}
?>
		...
		<div class="row">
			<div class="col-md-offset-2 col-md-8">
				<div class="text-hide">
					...
					<h5><?php if(isset($_POST['login'])){ echo autenticaloginincentivadorpf($login, $senha); } ?></h5>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-offset-1 col-md-10">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-6">
						<p>Não possui cadastro? <a href="verifica_incentivador_pf.php">Clique aqui.</a></p>
						<br />
					</div>
					<div class="col-md-6">
