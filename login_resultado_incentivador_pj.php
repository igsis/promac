...
if(isset($_POST['busca']))
{
	...
	{
		$busca = $_POST['busca'];
		$sql_busca = "SELECT * FROM incentivador_pessoa_juridica WHERE cnpj = '$busca' ORDER BY razaoSocial";
								...
								while($descricao = mysqli_fetch_array($query_busca))
								{
									echo "
										<tr>
											...
											<td><a href='recuperar_senha_incentiv_pj.php'><input type='submit' value='Esqueci a Senha' class='btn btn-theme btn-block'></a></td>
										</tr>
									";
								}
							?>
