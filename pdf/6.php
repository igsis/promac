...
if($tipoPessoa == 1) {
    ...
    $pdf->SetX($x);
    $pdf->SetFont('Arial', '', 11);
    $pdf->MultiCell(170, $l, utf8_decode("Eu, ".$rep['nome'].", RG n° ".$rep['rg'].", CPF nº ".$rep['cpf'].", representante legal da pessoa jurídica, ".$pj['razaoSocial'].", CNPJ nº ".$pj['cnpj'].", sediada no endereço ".$pj['logradouro'].", ".$pj['numero']." ".$pj['complemento'].", bairro ".$pj['bairro'].", CEP ".$pj['cep']. ", no município de ".$pj['cidade'].", venho declarar que:"));
}
