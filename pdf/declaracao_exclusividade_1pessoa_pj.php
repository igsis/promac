...
foreach ($eventos as $evento){
    ...
    $pdf->SetX($x);
    $pdf->SetFont('Arial', '', $f);
    $pdf->MultiCell(180, $l, utf8_decode("Eu, " . $evento['lider_nome'] . ", RG " . $evento['lider_rg'] . ", CPF " . $evento['lider_cpf'] . ",  sob penas da lei, declaro que sou representado exclusivamente pela empresa " . $evento['razao_social'] . "."));
    ...
    if (!empty($evento['rep2_nome'])) {
        $pdf->SetX($x);
        $pdf->SetFont('Arial', '', $f);
        $pdf->MultiCell(180, $l, utf8_decode($evento['razao_social'] . ", representada por " . $evento['rep1_nome'] . ", RG " . $evento['rep1_rg'] . ", CPF " . $evento['rep1_cpf'] . " e " . $evento['rep2_nome'] . ", RG " . $evento['rep2_rg'] . ", CPF " . $evento['rep2_cpf'] . ", declara sob penas da lei ser representante de " . $evento['nome_atracao'] . "."));
    } else {
        $pdf->SetX($x);
        $pdf->SetFont('Arial', '', $f);
        $pdf->MultiCell(180, $l, utf8_decode($evento['razao_social'] . ", representada por " . $evento['rep1_nome'] . ", RG " . $evento['rep1_rg'] . ", CPF " . $evento['rep1_cpf'] . " declara sob penas da lei ser representante de " . $evento['nome_atracao'] . "."));
    }
