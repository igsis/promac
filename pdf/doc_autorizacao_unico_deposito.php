...
<div class="sansSerif">
    ...
    <p style="text-align: justify">A Secretaria Municipal de Cultura, representada pelo Programa Municipal de Apoio a Projetos Culturais – Pro-Mac, autoriza o contribuinte incentivador <strong>XXXXXXXXXX</strong>, inscrito no CPF/CNPJ sob o nº <strong>XXXX</strong>, estando este com a documentação de acordo com o edital Pro-Mac 2020, a efetuar os depósitos dos valores de incentivo fiscal provenientes do imposto <strong>XXX</strong> para o projeto cultural aprovado denominado <strong>“<?= $nomeProjeto ?>”</strong>, conforme fora firmado no Contrato de Incentivo entre o incentivador acima e o proponente <?= $proponente ?>, <b>CNPJ n° <?= $documento ?></b>.</p>
    <br>
    ...
    <p>&nbsp;</p>
    <br><br>
    <p align="center"><b>_________________________________</b></p>
    <p align="center"><b>Assinatura</b></p>
</div>
</body>
</html>