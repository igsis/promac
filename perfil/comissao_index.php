...
?>
    <section id="list_items" class="home-section bg-white">
        <div class="container">
            ...
            <div class="form-group">
                <h5>Lista de projetos com recurso encaminhado à Comissão</h5>
            </div>
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    <div class="table-responsive list_info">
						...
						if($direcao['idNivelAcesso'] == 3)
						{
						$sql = "SELECT * FROM projeto WHERE publicado = 1 AND idStatus = 24 ORDER BY envioComissao ";
							}
							else
							{
						$sql = "SELECT * FROM projeto WHERE publicado = 1 AND idComissao = $idPf AND idStatus = 24 ORDER BY envioComissao ";	
						}
					$query = mysqli_query($con,$sql);
					$num = mysqli_num_rows($query);
					if($num > 0)
           ...
           <div class="form-group">
                <h5>Lista de projetos com complementação de recurso enviado à Comissão</h5>
            </div>
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    <div class="table-responsive list_info">
						...
						if($direcao['idNivelAcesso'] == 3)
						{
						$sql = "SELECT * FROM projeto WHERE publicado = 1 AND idStatus = 30 ORDER BY envioComissao ";
							}
							else
							{
						$sql = "SELECT * FROM projeto WHERE publicado = 1 AND idComissao = $idPf AND idStatus = 30 ORDER BY envioComissao ";	
						}
					$query = mysqli_query($con,$sql);
					$num = mysqli_num_rows($query);
					if($num > 0)
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
					...
					?>
                       ...
                       <div class="form-group">
                <h5>Lista de projetos com complemento enviado</h5>
            </div>
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    <div class="table-responsive list_info">
