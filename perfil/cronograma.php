			...
			<div class="col-md-offset-1 col-md-10">
				...
				<div class="row">
					<div class=" col-md-12">
						<form method="POST" action="?perfil=cronograma" class="form-horizontal" role="form">
							...
							<div class="form-group">
								<div class="col-md-offset-2 col-md-8">
									<input type="button" name="insereCronograma" class="btn btn-theme btn-lg btn-block" value="Inserir">
								</div>
							</div>
						</form>
				...
				<script>
					...
					for(let etapa of etapas){
						veliricador.push(isNaN(parseFloat(etapa.value))) 
						preencher(etapa)
					}					
					...
					<table class='table table-condensed'>
						...
						<tbody>
							...
							<tr>
								...
								<td class='list_description'><?= $cronograma['captacaoRecurso'] ?? '' ?></td>
							</tr>
							<tr>
								<td class='list_description'>Pré-Produção</td>
								<td class='list_description'><?= $cronograma['preProducao'] ?? '' ?></td>
							</tr>
							<tr>
								<td class='list_description'>Produção</td>
								<td class='list_description'><?= $cronograma['producao'] ?? '' ?></td>
							</tr>
							<tr>
								<td class='list_description'>Pós-Produção</td>
								<td class='list_description'><?= $cronograma['posProducao'] ?? '' ?></td>
							</tr>
							<tr>
								<td class='list_description'>Prestação de Contas</td>
								<td class='list_description'><?= $cronograma['prestacaoContas'] ?? '' ?></td>
							</tr>
						</tbody>
					</table>
				</div>	
