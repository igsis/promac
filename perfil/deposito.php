                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8">
                        <form class="form-horizontal" role="form"
                              action="?perfil=cadastro_deposito&idReserva=<?= $idReserva ?>&idProjeto=<?= $idProjeto ?>"
                              method="POST">
                                    ...
                                    <tr>
                                        ...
                                        <td class='list_description'>
                                            <form method='POST'
                                                ...
                                                <input type="hidden" name="idIncentivador"
                                                       value="<?php echo $deposito['idIncentivador']; ?>">
                                                <input type="hidden" name="nome"
                                                       value="<?php echo $deposito['nome']; ?>">
                                                <input type="hidden" name="tipoPessoa"
                                                       value="<?php echo $deposito['tipoPessoa']; ?>">
                                                <input type="hidden" name="idReserva"
                                                       value="<?php echo $deposito['idReserva']; ?>">
                                        ...
                                        <td class='list_description'>
                                            <form method='POST'
                                                ...
                                                <input type="hidden" name="idIncentivador"
                                                       value="<?php echo $deposito['idIncentivador']; ?>">
                                                <input type="hidden" name="nome"
                                                       value="<?php echo $deposito['razaoSocial']; ?>">
                                                <input type="hidden" name="tipoPessoa"
                                                       value="<?php echo $deposito['tipoPessoa']; ?>">
                                                <input type="hidden" name="idReserva"
                                                       value="<?php echo $deposito['idReserva']; ?>">
