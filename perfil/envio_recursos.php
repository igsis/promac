				...
				if(in_array($ext, $allowedExts)) //Pergunta se a extensão do arquivo, está presente no array das extensões permitidas
				{
					if(move_uploaded_file($nome_temporario, $dir.$new_name))
					{
						$sql_insere_arquivo = "INSERT INTO `upload_arquivo` (`idTipo`, `idPessoa`, `idListaDocumento`, `arquivo`, `dataEnvio`, `publicado`) VALUES ('3', '$idProjeto', '$y', '$new_name', '$hoje', '1'); ";
							$sql_status = "UPDATE projeto SET idStatus = '23' WHERE idProjeto = '$idProjeto'";
			...
			<div class="col-md-offset-1 col-md-10">
				...
				<div class="form-group">
					<div class="col-md-12">
						<div class="table-responsive list_info"><h6>Arquivo(s) Anexado(s)</h6>
							<?php listaArquivosPessoaComStatus($idProjeto,'3',"envio_recursos&idProjeto=$idProjeto"); ?>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-12">
						...
						<form method="POST" action="?perfil=envio_recursos&idProjeto=<?=$idProjeto?>" enctype="multipart/form-data">
							<table class='table table-condensed'>
								<tr class='list_menu'>
									<td>Tipo de Arquivo</td>
									<td></td>
