		...
		<div class="container"><?php include 'includes/menu_interno_pj.php'; ?>
			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10">
					<form method="POST" action="?perfil=incentivador_representante_pj_resultado_busca" class="form-horizontal" role="form">
...
{
	echo "<meta HTTP-EQUIV='refresh' CONTENT='0;URL=?perfil=incentivador_representante_pj_cadastro'>";
}
?>