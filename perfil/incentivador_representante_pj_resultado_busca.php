...
if(isset($_POST['busca']))
{
	...
	if($validacao == false)
	{
		echo "<meta HTTP-EQUIV='refresh' CONTENT='0;URL=?perfil=erros&p=erro_incentivador_representante1'>";
	}
	else
	{
		$busca = $_POST['busca'];
				...
				<div class="col-md-offset-1 col-md-10">
					...
					<div class="form-group">
						<div class="col-md-offset-2 col-md-8">
							<a href="?perfil=incentivador_representante_pj_cadastro"><input type="submit" value="Inserir outro representante" class="btn btn-theme btn-block"></a>
						</div>
					</div>
...
?>
	<section id="contact" class="home-section bg-white">
		<div class="container"><?php include 'includes/menu_interno_pj.php'; ?>
			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10">
				<form class="form-horizontal" role="form" action="?perfil=incentivador_representante_pj_cadastro" method="post">
					<div class="form-group">
