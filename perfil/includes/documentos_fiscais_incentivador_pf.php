                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="table-responsive list_info"><h6>Arquivo(s) Anexado(s)</h6>
                            ...
                            $teste = listaArquivosPessoa($idPf, $tipoPessoa, "includes/documentos_fiscais_incentivador_pf", "39, 40, 41, 42, 43, 53");
                            if ($teste == 6) {
                                echo "
                                      <form method='POST' action='?perfil=includes/incentivador_adm' enctype='multipart/form-data'>
