...
if (isset($_POST['iniciar_incentivo'])) {
    $sqlEtapa = "INSERT INTO incentivador_projeto (tipoPessoa, idPessoa, etapa) VALUES ($tipoPessoa, $idPf, 1)";
...
if (isset($_POST["enviar"])) {
    ...
    while ($arq = mysqli_fetch_array($query_arquivos)) {
        if (!verificaArquivosExistentesIncentivador($idPf, $arq['idListaDocumento'], 3) ) {
...
$docs = ['39, 40, 41, 42, 43, 54'];

foreach ($docs as $doc) {
    if (verificaArquivosExistentesIncentivador($idPf, $doc, 3)) {
        $arqAnexados = 'block';
        break;
    } else {
        $arqAnexados = 'none';
    ...
    <div class="container"><?php include 'menu_interno_pf.php' ?>
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
                ...
                ?>
                <!-- Exibir arquivos -->
                <div class="form-group" style="display: <?=$arqAnexados?>">
                    <div class="col-md-12">
                        <div class="table-responsive list_info"><h6>Arquivo(s) Anexado(s)</h6>
                            <?php

                            $arqsEnviados = listaArquivosPessoa($idPf, 3, "includes/documentos_fiscais_incentivador_pf", "39, 40, 41, 42, 43, 54");
                            if ($arqsEnviados == 6) {
                                echo "
