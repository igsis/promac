        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="admIncentivador">
                ...
                <div class="well">
                    ...
                    <form method="POST" action="?perfil=includes/incentivadorPJ_etapa3_visualiza_docs"
                ...
                <div class="well">
                    <div class="form-group">
                        ...
                        <div class="table-responsive list_info"><h6>Arquivo(s) Negado(s)</h6>
                            <?php
                            listaArquivosPessoa($idPj, $tipoPessoa, "includes/incentivadorPJ_etapa3_visualiza_docs", $negados, 'table-striped');
                            ?>
                        </div>
                    </div>
                </div>
