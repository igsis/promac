        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="admIncentivador">
                ...
                <div class="well">
                    ...
                    <form method="POST" action="?perfil=includes/incentivador_adm_pj"
                ...
                <div class="well">
                    <div class="form-group">
                        ...
                        <div class="table-responsive list_info"><h6>Arquivo(s) Negado(s)</h6>
                            <?php
                            listaArquivosPessoa($idPj, $tipoPessoa, "includes/incentivador_adm_pj", $negados, 'table-striped', $apagados);
                            ?>
                        </div>
                    </div>
                </div>
