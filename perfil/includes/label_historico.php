<div role="tabpanel" class="tab-pane fade" id="historico">
    ...
    <?php $sql_lista_historico = "SELECT st.status, hs.data AS data FROM historico_status AS hs INNER JOIN status AS st ON hs.idStatus = st.idStatus WHERE hs.idProjeto = '$idProjeto' ORDER BY hs.data,hs.idStatus";
