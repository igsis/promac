...
<!--            </tr>-->
            ...
            <tr>
                ...
                <td>
                    <form method="get" target="_blank" action="../pdf/Autorização_captação.doc" class="form-horizontal" role="form">
            ...
            <tr>
                ...
                <td>
                    <form method="get" target="_blank" action="../pdf/Certificado_Incetivo.doc" class="form-horizontal" role="form">
                        <button type="submit" style="border-radius: 5px;" class="btn btn-theme btn-sm btn-block" name="idProjeto">Abrir</button>
                    </form>
                </td>
            </tr>
