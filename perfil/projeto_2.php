                        ...
                        <form method="POST" action="?perfil=projeto_2" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" pattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$" oninvalid="setCustomValidity('Formato desejado: 1.000,99')" name="valorIncentivo" class="form-control" id="valorIncentivo" value="<?php echo isset($projeto['valorIncentivo']) ? dinheiroParaBr($projeto['valorIncentivo']) : null ?>" />
                                </div>
                                <div class="col-md-2">
                                    <label>Valor de outros financiamentos</label>
                                    <input type="text" pattern="([0-9]{1,3}\.)?[0-9]{1,3},[0-9]{2}$" oninvalid="setCustomValidity('Formato desejado: 1.000,99')" name="valorFinanciamento" class="form-control" id="valorFinanciamento" value="<?php echo isset($projeto['valorFinanciamento']) ? dinheiroParaBr($projeto['valorFinanciamento']) : null ?>" />
                                </div>
                            </div>
