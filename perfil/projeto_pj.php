										...
										if ($campo['idEtapaProjeto'] == 1) {
											...
											<td class='list_description'>
												<form method='POST' action='?perfil=projeto_visualizacao'>
													<input type='hidden' name='carregar' value='".$campo['idProjeto']."' />
													<input type ='submit' class='btn btn-theme btn-block' id='buttonVisualizar' value='visualizar'>
												</form>
											</td>";
										}
										echo "</tr>";
...
<script type="text/javascript">
    ...
    if (infosConta == 1) {
        ...
        swal("O botão será habilitado quando as informações forem inseridas no sistema!", '', 'warning');
    }
