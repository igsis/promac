	...
	<div class="container"><?php include 'includes/menu_interno_pf.php'; ?>
		<div class="form-group">
			...
			<?php
				...
				{?>
					<p><strong><font color="red">Alguns campos obrigatórios não foram preenchidos corretamente.<br/> Revise seu cadastro.</font></strong></p><br>
				<?php
				}
			?>
		 ...
		 <div class="well">
			...
			<p align="justify"><strong>RG ou RNE:</strong>
				<?php 
					if ($pf['rg'] == null)
					{
						$_SESSION['obrigatorio'] = 1;
						echo "Campo Vazio";
					}
					else
					{
						$_SESSION['obrigatorio'] = 0;
						echo $pf['rg'];
					}
				?><p>
