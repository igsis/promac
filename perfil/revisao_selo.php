...
function listaArquivosPessoaComStatus($idPessoa,$tipoPessoa,$pagina)
{
	...
	$sql = "SELECT *
			...
			AND arq.publicado = '1'
			AND list.idListaDocumento IN (62)";
...
{
	$sql_arquivos = "SELECT * FROM lista_documento WHERE idTipoUpload = '3' AND idListaDocumento IN (62)";
			...
			if($nome_arquivo != "")
			{
				...
				if(in_array($ext, $allowedExts)) //Pergunta se a extensão do arquivo, está presente no array das extensões permitidas
				{
					if(move_uploaded_file($nome_temporario, $dir.$new_name))
					{
						...
						$sql_status = "UPDATE projeto SET idEtapaProjeto = '42', idStatus = 1 WHERE idProjeto = '$idProjeto'";
                        $sql_historico = "INSERT INTO historico_etapa (idProjeto, idEtapaProjeto, data) VALUES ('$idProjeto', '42', '$hoje')";
						...
						if($query)
						{
							...
							$sql_insere_arquivo = " Arquivo: revisao_selo.php";
			...
			<div class="col-md-offset-1 col-md-10">
				...
				<div class="form-group">
					<div class="col-md-12">
						<div class="table-responsive list_info"><h6>Arquivo(s) Anexado(s)</h6>
							<?php listaArquivosPessoaComStatus($idProjeto,'3',"revisao_selo&idProjeto=$idProjeto"); ?>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-12">
						...
						<form method="POST" action="?perfil=revisao_selo&idProjeto=<?=$idProjeto?>" enctype="multipart/form-data">
							<table class='table table-condensed'>
								<tr class='list_menu'>
									<td>Tipo de Arquivo</td>
									<td></td>
								...
								?>
										<tr>
											<?php
											$doc = $arq['documento'];
											$query = "SELECT idListaDocumento FROM lista_documento WHERE documento='$doc' AND publicado='1' AND idTipoUpload='3' AND idListaDocumento IN (62)";
