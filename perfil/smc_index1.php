...
<section id="list_items" class="home-section bg-white">
    <div class="container">
        ...
        <?php
            ...
            {
                $sql = "SELECT idProjeto, nomeProjeto, protocolo, pf.nome, pf.cpf, razaoSocial, cnpj, areaAtuacao, pfc.nome AS comissao, etapaProjeto, pro.idEtapaProjeto AS idEtapaProjeto 
                    FROM projeto AS pro
                ...
                $num = mysqli_num_rows($query);
                ?>
                <div class='form-group'><h5><?=$campo['status'] . "-".  $campo['idEtapaProjeto']?></h5></div>
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        <div class="table-responsive list_info">
                            <table class='table table-condensed'>
