                            ...
                            <form class="form-horizontal" role="form"
                                ...
                                <?php if (!$dadosAdicionais): ?>
                                    <div class="alert alert-danger">
                                        Você já completou seus dados de cadastro? O PROMAC quer saber algumas coisas de
                                        você! Retorne ao menu
                                        <strong>"Informações Adicionais do Representante Legal"</strong> e complete seu
                                        cadastro. Após completar o cadastro, retorne aqui no campo de inscrição de
                ...
                if ($num > 0) {
                    if (!$dadosAdicionais) {
                        ...
                        <div class="alert alert-danger">
                            ...
                            Retorne ao menu
                            <strong>"Informações Adicionais do Representante Legal"</strong> e complete seu cadastro.
                            Após completar o cadastro, retorne aqui no campo de inscrição de projetos normalmente”
                        </div>
                    <?php }
                    echo "
