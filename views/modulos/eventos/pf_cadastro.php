            ...
            <div class="col-md-12">
                <div class="card card-info">
                    ...
                    <form class="form-horizontal formulario-ajax" method="POST"
                          action="<?= SERVERURL ?>ajax/pedidoFisicaAjax.php" role="form"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="pf_nome" placeholder="Digite o nome"
                                           maxlength="70" value="<?= $pf['nome'] ?? '' ?>" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nomeArtistico">Nome Artistico:</label>
                                    <input type="text" class="form-control" name="pf_nome_artistico"
                            ...
                            <div class="row">
                                ...
                                if (isset($_POST['pf_cpf']) || $pf['cpf'] != ""){
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="pf_rg" placeholder="Digite o RG"
                                               maxlength="20" value="<?= $pf['rg'] ?? '' ?>" required>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="cpf">CPF: </label>
                                        <input type="text" name="pf_cpf" class="form-control" id="cpf"
                                               value="<?= $documento ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="ccm">CCM:</label>
                                        <input type="text" id="ccm" name="pf_ccm" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="passaporte" name="pf_passaporte" class="form-control"
                                               value="<?= $documento ?>" readonly>
                                    </div>
                                    <?php
                                }
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="nit" name="ni_nit" class="form-control" maxlength="45"
                                           placeholder="Digite o NIT" value="<?= $pf['nit'] ?? '' ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <?php if ($cenica > 0): ?>
